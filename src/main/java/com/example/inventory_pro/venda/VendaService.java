...
import com.example.inventory_pro.produto.ProdutoService;
import com.example.inventory_pro.venda.dtos.VendaCreateDTO;
import com.example.inventory_pro.venda.dtos.VendaItemCreateDTO;
...
public class VendaService {
  ...
  public VendaResponseDTO criarVenda(VendaCreateDTO dto) {
    ...
    for (VendaItemCreateDTO itemDTO : dto.getItens()) {
      ...
      // produtoService.updateQuantidade(produto.getId(), (produto.getQuantidade() -
